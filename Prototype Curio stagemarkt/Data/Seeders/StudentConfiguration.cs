        ...
        public void Configure(EntityTypeBuilder<Student> builder)
        {
            ...
            builder.HasData(
                 new Student { Id = 1, Name = "Max", EmailAdress = "student1@example.com", Password = SecureHasher.Hash("wachtwoord"), Specialization = "Native", InternshipTeacherId = 1 },
                  new Student { Id = 2, Name = "JJ", EmailAdress = "student2@example.com", Password = SecureHasher.Hash("a"), Specialization = "Native", InternshipTeacherId = 2 },
                  new Student { Id = 3, Name = "Krijn", EmailAdress = "student1@example.com", Password = SecureHasher.Hash("wachtwoord"), Specialization = "Native", InternshipTeacherId = 1 },
                  ...
                  new Student { Id = 5, Name = "Wiardi", EmailAdress = "student1@example.com", Password = SecureHasher.Hash("wachtwoord"), Specialization = "Native", InternshipTeacherId = 1 },
                  new Student { Id = 6, Name = "Nigel", EmailAdress = "student2@example.com", Password = SecureHasher.Hash("a"), Specialization = "Native", InternshipTeacherId = 2 },
                  ...
                  new Student { Id = 8, Name = "Jonathan", EmailAdress = "student2@example.com", Password = SecureHasher.Hash("a"), Specialization = "Native", InternshipTeacherId = 1 },
